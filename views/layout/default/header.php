...
<head>
    ...
    <!-- Theme style -->
    <link rel="stylesheet" href="<?= $_layoutParams['ruta_css'] ?>AdminLTE.css">
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="<?= SITE_URL?>" class="logo">
            ...
            <span class="logo-lg"><b>Pacho</b>LTE</span>
        </a>
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <?php foreach ($_layoutParams['menu'] as $menu):?>
                    <?php  $clase = ($vista == $menu['id']) ? 'active' : 'treeview' ?>
                <li class="<?= $clase ?>">
                    <a href="<?= $menu['url']?>">
                        <i class="fa fa-dashboard"></i> <span><?= $menu['titulo'] ?></span>
